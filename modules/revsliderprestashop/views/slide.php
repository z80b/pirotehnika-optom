...
RevGlobalObject::setVar('sliderDelay', $slideDelay);
...
$bgFitX = (int) (UniteFunctionsRev::getVal($slideParams, "bg_fit_x", "100"));

$bgFitY = (int) (UniteFunctionsRev::getVal($slideParams, "bg_fit_y", "100"));



$bgPosition = UniteFunctionsRev::getVal($slideParams, "bg_position", "center top");

$bgPositionX = (int) (UniteFunctionsRev::getVal($slideParams, "bg_position_x", "0"));

$bgPositionY = (int) (UniteFunctionsRev::getVal($slideParams, "bg_position_y", "0"));



$bgEndPosition = UniteFunctionsRev::getVal($slideParams, "bg_end_position", "center top");

$bgEndPositionX = (int) (UniteFunctionsRev::getVal($slideParams, "bg_end_position_x", "0"));

$bgEndPositionY = (int) (UniteFunctionsRev::getVal($slideParams, "bg_end_position_y", "0"));
...
RevGlobalObject::setVar('useWpml', $useWpml);
RevGlobalObject::setVar('isWpmlExists', $isWpmlExists);
