...
<div class="form-group">
	...
	<div class="col-lg-9">
		...
		{/if}
			<div class="col-lg-3">
 				<input type="hidden" name="my_id_shop" value="{if $currentTab->getFieldValue($currentObject, 'my_id_shop')}{$currentTab->getFieldValue($currentObject, 'my_id_shop')|floatval}{else}{(int)Context::getContext()->shop->id}{/if}" />
			</div>
			<p class="checkbox">
				<label>
