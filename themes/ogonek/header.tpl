						...
						<div class="container" >
							<div class="row">
								...
								<div class="col-sm-9 col-xs-12">
										...
										<div class="col-sm-3 col-xs-12">
											<div id="app_header_logo" >
												<a href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{$shop_name|escape:'html':'UTF-8'}">
													<img class="logo img-responsive2" src="{$logo_url}" alt="{$shop_name|escape:'html':'UTF-8'}"{if isset($logo_image_width) && $logo_image_width} width="{$logo_image_width}"{/if}{if isset($logo_image_height) && $logo_image_height} height="{$logo_image_height}"{/if}/>
												</a>
											</div>
										</div>
									...
									<div class="row mt-20">
										<div class="slogan col-sm-12">
											<!--<p class="sim_text" style="color:gray; font-size: 30px;">C Доставка по России</p>-->
										</div>
									</div>
