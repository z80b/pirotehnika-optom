...
{else}
	...
	<form action="{$request_uri}" method="post" class="contact-form-box" enctype="multipart/form-data">
		<fieldset>
			...
			<div class="submit">
				<button type="submit" name="submitMessage" id="submitMessage" onclick="yaCounter46713966.reachGoal('CONT_FORM'); return true;" class="button btn btn-default button-medium"><span>{l s='Send'}<i class="icon-chevron-right right"></i></span></button>
			</div>
		</fieldset>
	</form>
{/if}
