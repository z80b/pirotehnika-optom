...
(function() {
  ...
  var group_id = '161148829'; // вписать id вашей группы
  var topic_id = '37012519'; // вписать id поста
//  var JSONReviewsGeneratorReference = 'https://gittest/d_reviews.php'; // вписать путь к файлу d_reviews.php (например https://my-site.ru/d_reviews.php)
  var JSONReviewsGeneratorReference = '../../themes/ogonek/vkotzivy/php/d_reviews.php'; // вписать путь к файлу d_reviews.php (например https://my-site.ru/d_reviews.php)
//  http://127.0.0.1/openserver
  var quantityComments = 15; // количество комментариев для вывода
