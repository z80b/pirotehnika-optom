...
<div class="addresses clearfix">
			<p class="cart_navigation clearfix">
				...
				<button type="submit" name="processAddress" class="button btn btn-default button-medium" onclick="yaCounter46713966.reachGoal('STEP2'); return true;">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			...
			<p class="checkbox addressesAreEquals"{if $cart->isVirtualCart()} style="display:none;"{/if} style="display:none;">
