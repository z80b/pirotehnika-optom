...
//$filename66 = 'somefile.txt';
//$text66 = 'No Ajax. Controller - '.$sql ;
//file_put_contents($filename66, PHP_EOL.$text66, FILE_APPEND);
     ...
     * @return array|bool|object|null
     */
    public function getRowAll($sql, $use_cache = true)
    {
        if ($sql instanceof DbQuery) {
            $sql = $sql->build();
        }
