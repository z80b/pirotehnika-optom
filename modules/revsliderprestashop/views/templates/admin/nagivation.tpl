...
<div id="viewWrapper" class="view_wrapper">
	<div class='wrap'>
		...
		<div class="setting_box navig" style="margin-bottom: 20px;">
			<h3><span class="setting-step-number">1</span><span style="max-width: 400px;">Select the Navigation Category to Edit</span> <a original-title="" class="button-primary revblue" id="rs-add-new-navigation-element" href="javascript:void(0);">Add New</a></h3>
			
			<div class="table-titles">				
				<div class="rs-nav-table-cell rs-nav-table-title">#ID</div>
				<div class="rs-nav-table-cell rs-nav-table-title">Skin Name</div>
				<div class="rs-nav-table-cell rs-nav-table-title">Arrows</div>
				<div class="rs-nav-table-cell rs-nav-table-title">Bullets</div>
				<div class="rs-nav-table-cell rs-nav-table-title">Thumbs</div>
				<div class="rs-nav-table-cell rs-nav-table-title">Tabs</div>	
				<div class="rs-nav-table-cell rs-nav-table-title" style="width:auto;text-align:left;padding:0px 20px;">Actions</div>
			</div>
		...
		<div class="setting_box navig" style="margin-bottom: 20px;">
			<div class="rs-editing-wrapper" style="display: none;">
				<h3 style="border:0;"><span class="setting-step-number">2</span><span style="max-width: 400px;">Editing <span class="rs-nav-editing-title"></span></span> <a href="javascript:void(0);" class="button-primary revred rs-remove-nav-element">Remove</a></h3>
				<div class="rs-editing-markups-wrap">
					<div class="rs-markup-selector">
						<div class="rs-selector-title">Markup</div> <span class="rs-editor-open-field"><i class="revicon-list-add"></i></span>
					</div>
					<div class="rs-markup-wrapper" style="display: none;">
									...
									<!--	<li id="reset-markup-arrow" data-call="arrows_markup"><span class="libtn"><?php _e('Reset Defaults', 'revslider'); ?><span class="more-values-available resetme"></span></span></li>
										...
										<li><span class="libtn">Parameters<span class="more-values-available"></span></span>
											<ul style="display: none;" class="rs-element-add">
												<li data-call="params_special" data-paramid="title"><span class="libtn">Slide Title</span></li>
												<li data-call="params_special" data-paramid="description"><span class="libtn">Slide Description</span></li>
												{for $i=1 to 10}
													<li data-call="params_markup" data-paramid="{$i|intval}"><span class="libtn">Parameter {$i|intval}</span></li>
												{/for}
											</ul>
										</li>
									</ul>
						...
						<div class="rs-selector-title">CSS</div> <span class="rs-editor-open-field"><i class="revicon-list-add"></i></span>
					</div>
					<div class="rs-css-wrapper" style="display: none;">
						<div class="rs-css-elements">
							<div style="padding: 20px;" class="closemeshowhide">
								<div class="helper-wrappers rea-open">
									<h4><span class="libtn">Style Helper<span class="more-values-available"></span></span></h4>
									<ul class="rs-element-list collapsable" style="display:block">
										<li data-call="color_value"><span class="libtn">Color Value<span class="more-values-available"></span></span>
											<div style="display: none;" class="rs-element-add rs-element-add-color">										
												...
												<a href="javascript:void(0);" id="rs-add-css-color" class="button-primary revblue" original-title="">Add</a>
											</div>
										</li>
										<li data-call="border_radius"><span class="libtn">Border Radius<span class="more-values-available"></span></span>
											<div style="display: none;" class="rs-element-add rs-element-add-border-radius">
												...
												<span class="tp-clearfix"></span>
												<a href="javascript:void(0);" id="rs-add-css-border-radius" class="button-primary revblue" original-title="">Add</a>
											</div>
										</li>
										<li data-call="border"><span class="libtn">Border<span class="more-values-available"></span></span>
											<div style="display: none;" class="rs-element-add rs-element-add-border">
												...
												<span class="tp-clearfix"></span>																				
												<a href="javascript:void(0);" id="rs-add-css-border" class="button-primary revblue" original-title="">Add</a>
											</div>
										</li>
										<li data-call="text_shadow"><span class="libtn">Text-Shadow<span class="more-values-available"></span></span>
											<div style="display: none;" class="rs-element-add rs-element-add-text-shadow">
												...
												<span class="tp-clearfix"></span>										
												<a href="javascript:void(0);" id="rs-add-css-text-shadow" class="button-primary revblue" original-title="">Add</a>
											</div>
										</li>
										<li data-call="box_shadow"><span class="libtn">Box-Shadow<span class="more-values-available"></span></span>
											<div style="display: none;" class="rs-element-add rs-element-add-box-shadow">
												...
												<span class="tp-clearfix"></span>										
												<a href="javascript:void(0);" id="rs-add-css-box-shadow" class="button-primary revblue" original-title="">Add</a>
											</div>
										</li>
										<li data-call="font_families"><span class="libtn">Font Family<span class="more-values-available"></span></span>
											<div style="display: none;" class="rs-element-add rs-element-add-box-shadow">
												...
												<a href="javascript:void(0);" id="rs-add-css-font-family" class="button-primary revblue" original-title="">Add</a>
											</div>
										</li>
									</ul>								
								</div>
				...
				<div class="rs-editing-preview-wrap">
					...
					<span class="little-info">Live Preview - Hover &amp; Click for test</span>
		...
		<a class="button-primary revgreen" id="rs-save-navigation-style" href="javascript:void(0);"><i class="rs-icon-save-light"></i>Save All Changes</a>
	
	
		<script type="text/javascript">
		
			{* var rs_navigations = jQuery.parseJSON({{RevSliderFunctions::jsonEncodeForClientSide($navigs)}}) || []; *}
			...
			jQuery(document).ready(function(){
				...
				function rs_add_all_navigation_entries(){
					rs_add_navigation_header('Custom Navigations', 'rs-custom-t-wrap');
					
					for(var i = 1; i<=2; i++){
						if(i === 2) rs_add_navigation_header('Default Navigations', 'rs-default-t-wrap');
