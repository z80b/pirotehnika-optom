 ...
 -->			
			<ul class="bullet list-group">
				{foreach from=$cms_pages item=cmspages}
					<li>
						<a class="catAppBtn list-group-item__" href="{$link->getCMSLink($cmspages.id_cms, $cmspages.link_rewrite)|escape:'html':'UTF-8'}">
							<div>
								<span>{$cmspages.meta_title|escape:'html':'UTF-8'}</span>
							</div>
						</a>
					</li>
				{/foreach}
