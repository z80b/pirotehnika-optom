...
$operations = RevGlobalObject::getVar('operations');
...
<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important; min-width:1140px !important">
    <div class="box-closed tp-accordion" style="border-bottom:5px solid #ddd;">
        <ul class="rs-layer-settings-tabs">
            ...
            <?php $slide = RevGlobalObject::getVar('slide');
            if ($slide->isStaticSlide()) {

                ?>
                <li data-content="#rs-static-content-wrapper"><i style="height:45px" class="rs-mini-layer-icon eg-icon-dribbble-1 rs-toolbar-icon"></i><?php _e("Static Layers", 'revslider');
...
?>
    ...
    $parallaxisddd = RevGlobalObject::getVar('parallaxisddd');
    ...
    if ($parallaxisddd != "off") {
        ...
        ?>
                    ...
                    <span class="rs-layer-toolbar-box" id="put_layer_ddd_to_z">
                        <span><?php _e("Attach to", 'revslider');

        ?></span>
                        <span class="rs-layer-toolbar-space"></span>
                        <select class="rs-layer-input-field" style="width:149px" id="parallax_layer_ddd_zlevel" name="parallax_layer_ddd_zlevel">									
                            <option value="layers"><?php _e('Layers 3D Group', 'revslider');

        ?></option>							
                            <option value="bg"><?php _e('Background 3D Group', 'revslider');
    ...
    ?>
            ...
            <span class="rs-layer-toolbar-box" id="layer_static_wrapper" <?php echo ($isTemplate == "true") ? ' style="display: none;"' : ''; ?>>
                ...
                <select id="layer_static_start" name="static_start">
                    <?php
                    $arrSlideNames = RevGlobalObject::getVar('arrSlideNames');
...
?>
    ...
    <!-- END OF AMAZING TOOLBAR -->
                     ...
                     $style = RevGlobalObject::getVar('style');
                     $style .= ' margin: 0 auto;';
                     $maxbgwidth = RevGlobalObject::getVar('maxbgwidth');
                     $tempwidth_jq = $maxbgwidth;
                     RevGlobalObject::setVar('tempwidth_jq', $tempwidth_jq);

                     $style_wrapper = RevGlobalObject::getVar('style_wrapper');
                     ...
                     $settings = RevGlobalObject::getVar('settings');
    ...
    foreach ($hor_lines as $lines) {
        ...
        <div id="top-toolbar-wrapper">
            ...
            <!-- DESKTOP / TABLET / PHONE SIZING -->
                        ...
                        $adv_resp_sizes = RevGlobalObject::getVar('adv_resp_sizes');
                        $enable_custom_size_notebook = RevGlobalObject::getVar('enable_custom_size_notebook');
                        $enable_custom_size_tablet = RevGlobalObject::getVar('enable_custom_size_tablet');
                        $enable_custom_size_iphone = RevGlobalObject::getVar('enable_custom_size_iphone');
...
<?php
$divbgminwidth = RevGlobalObject::getVar('divbgminwidth');
$class_wrapper = RevGlobalObject::getVar('class_wrapper');
$divLayersClass = RevGlobalObject::getVar('divLayersClass');
$divLayersWidth = RevGlobalObject::getVar('$divLayersWidth');
