...
class AdminControllerCore extends Controller
{
    ...
    protected $actions_available = array('view', 'edit', 'duplicate', 'delete', 'movement');
...
//file_put_contents('somefile.txt', PHP_EOL.$text66, FILE_APPEND);
    ...
    {
//if ((($this->id == 40) || ($this->id == 109)) || ($this->aiax))	ddd('Function AdminController.postProcess - '.$this->aiax);
//if ($this->aiax)	ddd('Function AdminController.postProcess - '.$this->id);
        try {
            if ($this->ajax) {
                // from ajax-tab.php
...
//if ((($this->id == 40) || ($this->id == 109)))	ddd('Function AdminController.postProcess without Ajax- '.$this->id);
                // Process list filtering
//$text66 = '  ajax  - '.'$this->filter = '.$this->filter.' $this->action = '.$this->action ;
//file_put_contents('somefile.txt', PHP_EOL.$text66, FILE_APPEND);
...
//file_put_contents('somefile.txt', PHP_EOL.$text66, FILE_APPEND);
    ...
    public function initContent()
    {
        ...
        if ($this->display == 'edit' || $this->display == 'add') {
            ...
            $this->content .= $this->renderMypanel();
...
//$text66 = '  ajax  - '.'AdminController -  1*'.$this->id_object ;
//file_put_contents('somefile.txt', PHP_EOL.$text66, FILE_APPEND);
