							...
							<tbody>
								...
								<tr class="payment_information" style="display: none;">
									<td colspan="5">
										...
										<div class="input-group ">
											<select name="my_payment_transaction_id{$payment->id}" class="my_payment_transaction_id" value="{$payment->transaction_id|escape:'html':'UTF-8'}"/>
												...
												<option {if ($payment->transaction_id == "Вячеслав")} selected="selected"{/if}>Вячеслав</option>
												<option {if ($payment->transaction_id == "Николай")} selected="selected"{/if}>Николай</option>
											</select>
									...
									<td class="actions">
										...
										<br>
										<br>
										<button id="but_submitMyRemovePayment" class="btn btn-primary" type="submit" name="submitMyRemovePayment">
											&nbsp;&nbsp;&nbsp;{l s='Remove'}&nbsp;&nbsp;&nbsp;
										</button>
									</td>
