...
class AdminPPreferencesControllerCore extends AdminController
{
        ...
        $this->fields_options = array(
            ...
            'fo_product_page' => array(
                ...
                'fields' =>    array(
                    ...
                    'PS_IS_SHOW_PRODUCTS' => array(
                        'title' => $this->l('Показывать отсутствующие товары'),
                        'validation' => 'isBool',
                        'cast' => 'intval',
                        'required' => false,
                        'type' => 'bool'
    ...
    public function beforeUpdateOptions()
    {
        ...
        if (Configuration::get('PS_ADVANCED_STOCK_MANAGEMENT') == 0 && (int)Tools::getValue('PS_ADVANCED_STOCK_MANAGEMENT') == 0) {
