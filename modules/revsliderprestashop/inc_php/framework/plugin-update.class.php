...
class RevSliderPluginUpdate
{
    ...
    public static function addV5Styles()
    {
        ...
        foreach ($v5 as $v5class) {
            $result = $db->fetch(_DB_PREFIX_.GlobalsRevSlider::TABLE_CSS_NAME, "handle = '".$v5class['handle']."'");
            if (empty($result)) {
                //add v5 style
                $db->insert(_DB_PREFIX_.GlobalsRevSlider::TABLE_CSS_NAME, $v5class);
            }
        }
    }
    ...
    public static function updateCssStyles()
    {
        ...
        $default_classes = RevSliderCssParser::defaultCssClasses();
        ...
        foreach ($styles as $key => $attr) {
            if (@RevsliderPrestashop::getIsset($attr['advanced'])) {
                $adv = Tools::jsonDecode($attr['advanced'], true); // = array('idle' => array(), 'hover' => '');
            } else {
                $adv = array('idle' => array(), 'hover' => '');
            }
            
            if (!@RevsliderPrestashop::getIsset($adv['idle'])) {
                $adv['idle'] = array();
            }
            if (!@RevsliderPrestashop::getIsset($adv['hover'])) {
                $adv['hover'] = array();
            }
            
            //only do this to styles prior 5.0
            $settings = Tools::jsonDecode($attr['settings'], true);
            if (!empty($settings) && @RevsliderPrestashop::getIsset($settings['translated'])) {
            ...
            if (!empty($idle)) {
                foreach ($idle as $style => $value) {
                    ...
                    if (!@RevsliderPrestashop::getIsset($cs[$style])) {
            ...
            if (!@RevsliderPrestashop::getIsset($settings['version'])) {
                if (@RevsliderPrestashop::getIsset($default_classes[$styles[$key]['handle']])) {
...
//		global $wpdb;
//		
//		if($wpdb->getVar("SHOW TABLES LIKE '".RevSliderGlobals::$table_settings."'") == RevSliderGlobals::$table_settings) {
//			$result = $wpdb->getRow("SELECT `general` FROM ".RevSliderGlobals::$table_settings, ARRAY_A);
//			if(@RevsliderPrestashop::getIsset($result['general'])){
                            ...
                            foreach ($layers as $lk => $layer) {
                                if (RevSliderFunctions::getVal($layer, 'x_start', false) == false) { //values are not set, set them now through
                                    ...
                                    foreach ($inAnimations as $handle => $anim) {
                                        if ($handle == $animation) {
                                            $anim_values = (@RevsliderPrestashop::getIsset($anim['params'])) ? $anim['params'] : '';
                                    ...
                                    foreach ($outAnimations as $handle => $anim) {
                                        if ($handle == $endanimation) {
                                            $anim_endvalues = (@RevsliderPrestashop::getIsset($anim['params'])) ? $anim['params'] : '';
                        ...
                        if (!empty($layers) && is_array($layers)) {
                            foreach ($layers as $lk => $layer) {
                                ...
                                if (empty($def_val)) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['params']['font-family'])) {
                                        $def_val['font-family'] = $wws['params']['font-family'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['padding'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['params']['font-style'])) {
                                        $def_val['font-style'] = $wws['params']['font-style'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['text-decoration'])) {
                                        $def_val['text-decoration'] = $wws['params']['text-decoration'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['background-color'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['params']['background-transparency'])) {
                                        ...
                                        if (@RevsliderPrestashop::getIsset($wws['params']['background-color'])) {
                                            $def_val['background-transparency'] = RevSliderFunctions::getTransFromRgba($wws['params']['background-color'], true);
                                        }
                                    }
                                    
                                    if (@RevsliderPrestashop::getIsset($wws['params']['border-color'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['params']['border-style'])) {
                                        $def_val['border-style'] = $wws['params']['border-style'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['border-width'])) {
                                        $def_val['border-width'] = $wws['params']['border-width'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['border-radius'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['params']['x'])) {
                                        $def_val['x'] = $wws['params']['x'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['y'])) {
                                        $def_val['y'] = $wws['params']['y'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['z'])) {
                                        $def_val['z'] = $wws['params']['z'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['skewx'])) {
                                        $def_val['skewx'] = $wws['params']['skewx'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['skewy'])) {
                                        $def_val['skewy'] = $wws['params']['skewy'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['scalex'])) {
                                        $def_val['scalex'] = $wws['params']['scalex'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['scaley'])) {
                                        $def_val['scaley'] = $wws['params']['scaley'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['opacity'])) {
                                        $def_val['opacity'] = $wws['params']['opacity'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['xrotate'])) {
                                        $def_val['xrotate'] = $wws['params']['xrotate'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['yrotate'])) {
                                        $def_val['yrotate'] = $wws['params']['yrotate'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['2d_rotation'])) {
                                        $def_val['2d_rotation'] = $wws['params']['2d_rotation'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['2d_origin_x'])) {
                                        $def_val['2d_origin_x'] = $wws['params']['2d_origin_x'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['2d_origin_y'])) {
                                        $def_val['2d_origin_y'] = $wws['params']['2d_origin_y'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['pers'])) {
                                        $def_val['pers'] = $wws['params']['pers'];
                                    }
                                    
                                    if (@RevsliderPrestashop::getIsset($wws['params']['color'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['params']['font-weight'])) {
                                        $static_styles['font-weight'] = $wws['params']['font-weight'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['font-size'])) {
                                        $static_styles['font-size'] = $wws['params']['font-size'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['params']['line-height'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['advanced']) && @RevsliderPrestashop::getIsset($wws['advanced']['idle']) && is_array($wws['advanced']['idle']) && !empty($wws['advanced']['idle'])) {
                                        $css_idle = '{'."\n";
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['color'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['text-decoration'])) {
                                        $defh_val['text-decoration'] = $wws['hover']['text-decoration'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['background-color'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['background-transparency'])) {
                                        ...
                                        if (@RevsliderPrestashop::getIsset($wws['hover']['background-color'])) {
                                            $defh_val['background-transparency'] = RevSliderFunctions::getTransFromRgba($wws['hover']['background-color'], true);
                                        }
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['border-color'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['border-style'])) {
                                        $defh_val['border-style'] = $wws['hover']['border-style'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['border-width'])) {
                                        $defh_val['border-width'] = $wws['hover']['border-width'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['border-radius'])) {
                                    ...
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['x'])) {
                                        $defh_val['x'] = $wws['hover']['x'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['y'])) {
                                        $defh_val['y'] = $wws['hover']['y'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['z'])) {
                                        $defh_val['z'] = $wws['hover']['z'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['skewx'])) {
                                        $defh_val['skewx'] = $wws['hover']['skewx'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['skewy'])) {
                                        $defh_val['skewy'] = $wws['hover']['skewy'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['scalex'])) {
                                        $defh_val['scalex'] = $wws['hover']['scalex'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['scaley'])) {
                                        $defh_val['scaley'] = $wws['hover']['scaley'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['opacity'])) {
                                        $defh_val['opacity'] = $wws['hover']['opacity'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['xrotate'])) {
                                        $defh_val['xrotate'] = $wws['hover']['xrotate'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['yrotate'])) {
                                        $defh_val['yrotate'] = $wws['hover']['yrotate'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['2d_rotation'])) {
                                        $defh_val['2d_rotation'] = $wws['hover']['2d_rotation'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['2d_origin_x'])) {
                                        $defh_val['2d_origin_x'] = $wws['hover']['2d_origin_x'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['2d_origin_y'])) {
                                        $defh_val['2d_origin_y'] = $wws['hover']['2d_origin_y'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['speed'])) {
                                        $defh_val['speed'] = $wws['hover']['speed'];
                                    }
                                    if (@RevsliderPrestashop::getIsset($wws['hover']['easing'])) {
                                        $defh_val['easing'] = $wws['hover']['easing'];
                                    }
                                    
                                    if (@RevsliderPrestashop::getIsset($wws['advanced']) && @RevsliderPrestashop::getIsset($wws['advanced']['hover']) && is_array($wws['advanced']['hover']) && !empty($wws['advanced']['hover'])) {
                                        $css_hover = '{'."\n";
                                    ...
                                    if (!@RevsliderPrestashop::getIsset($layers[$lk]['inline'])) {
    ...
    public static function addGeneralSettings($sliders = false)
    {
        ...
        if (!empty($sliders) && is_array($sliders)) {
            ...
            foreach ($sliders as $slider) {
                ...
                if (!@RevsliderPrestashop::getIsset($settings['version']) || version_compare($settings['version'], 5.0, '<')) {
    ...
    public static function changeGeneralSettings507($sliders = false)
    {
        ...
        if (!empty($sliders) && is_array($sliders)) {
            foreach ($sliders as $slider) {
                ...
                if (!@RevsliderPrestashop::getIsset($settings['version']) || version_compare($settings['version'], '5.0.7', '<')) {
            ...
            foreach ($sliders as $slider) {
                ...
                if (!empty($slides) && is_array($slides)) {
                    foreach ($slides as $slide) {
                        ...
                        $ml_id = '';
                        if ($image !== '') {
                            $ml_id = get_image_id_by_url($image);
                        }
                        if ($image == '' && $image_id == '') {
                            continue;
