            ...
            <div class="ps-product__cell">
                <div class="ps-product__row">
                    ...
                    {if isset($product.features)}
                        {section loop=$product.features name=index max=2}
                        <div class="ps-product__option ps-option">
                            <b class="ps-option__title">{$product.features[index].name}:</b>
                            <span class="ps-option__value">{$product.features[index].value}</span>
                        </div>
                        {/section}
                    {/if}
                    </div>
