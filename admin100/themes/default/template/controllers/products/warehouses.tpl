			...
			{foreach from=$warehouses item=warehouse name=data}
			    <div class="panel panel-default">
					...
					<div id="warehouse-{$warehouse['id_warehouse']}">
							...
							<button type="button" class="btn btn-default check_all_warehouse" value="check_warehouse_{$warehouse['id_warehouse']}"><i class="icon-check-sign"></i> {l s='Mark / Unmark all product combinations as stored in this warehouse'}</button>RRRR
							<!--<tr>
