...
class RevSliderFacebook
{
    ...
    public function get_photo_sets($user_id, $item_count = 10, $app_id, $app_secret)
    {
        ...
        $photo_sets_list = Tools::jsonDecode(wp_remote_fopen($url));
        //echo '<pre>';
        //print_r($photo_sets_list);
        //echo '</pre>';

        if (@RevsliderPrestashop::getIsset($photo_sets_list->data)) {
    ...
    public function get_photo_set_photos($photo_set_id, $item_count = 10, $app_id, $app_secret)
    {
        ...
        $photo_set_photos = Tools::jsonDecode(wp_remote_fopen($url));
        ...
        /*
          ...
          echo '</pre>';
         */
        if (@RevsliderPrestashop::getIsset($photo_set_photos->data)) {
    ...
    public function get_photo_feed($user, $app_id, $app_secret, $item_count = 10)
    {
        ...
        $feed = Tools::jsonDecode(wp_remote_fopen($url));
        if (@RevsliderPrestashop::getIsset($feed->data)) {
...
class RevSliderTwitterApi
{
    ...
    private function get_bearer_token()
    {
        ...
        if (@RevsliderPrestashop::getIsset($response['info']['http_code']) && 200 != $response['info']['http_code']) {
        ...
        if (@RevsliderPrestashop::getIsset($resp->access_token)) {
            update_option('twitter_bearer_token', $resp->access_token);
    ...
    public function query($query, $query_args = array(), $stop = false)
    {
        ...
        if (@RevsliderPrestashop::getIsset($response['info']['http_code'])) {
...
//                } elseif ( !empty( $error_object ) && @RevsliderPrestashop::getIsset( $error_object['response']['message'] ) ) {
...
class RevSliderInstagram
{
    ...
    public function get_public_photos($search_user_id, $count)
    {
        ...
        $rsp = Tools::jsonDecode(wp_remote_fopen($url));
        if (@RevsliderPrestashop::getIsset($rsp->data)) {
...
class RevSliderFlickr
{
    ...
    private function call_flickr_api($params)
    {
        ...
        $rsp = Tools::jsonDecode(wp_remote_fopen($url));        
        if (@RevsliderPrestashop::getIsset($rsp)) {
    ...
    public function get_user_from_url($user_url)
    {
        ...
        if (@RevsliderPrestashop::getIsset($user_info->user->id)) {
    ...
    public function get_group_from_url($group_url)
    {
        ...
        if (@RevsliderPrestashop::getIsset($group_info->group->id)) {
    ...
    public function get_public_photos($user_id, $item_count = 10)
    {
        ...
        if (@RevsliderPrestashop::getIsset($public_photos_list->photos->photo)) {
    ...
    public function get_photo_set_photos($photo_set_id, $item_count = 10)
    {
        ...
        if (@RevsliderPrestashop::getIsset($photo_set_photos->photoset->photo)) {
    ...
    public function get_group_photos($group_id, $item_count = 10)
    {
        ...
        if (@RevsliderPrestashop::getIsset($group_pool_photos->photos->photo)) {
    ...
    public function get_gallery_from_url($gallery_url)
    {
        ...
        if (@RevsliderPrestashop::getIsset($gallery_info->gallery->id)) {
    ...
    public function get_gallery_photos($gallery_id, $item_count = 10)
    {
        ...
        if (@RevsliderPrestashop::getIsset($gallery_photos_list->photos->photo)) {
...
class RevSliderYoutube
{
    ...
    public function get_playlists()
    {
        ...
        $rsp = Tools::jsonDecode(wp_remote_fopen($url));
        if (@RevsliderPrestashop::getIsset($rsp->items)) {
            return $rsp->items;
        } else {
            return false;
        }
