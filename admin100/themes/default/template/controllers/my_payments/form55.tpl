...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#submitSavePayment').on('click',function(){
			var id_new_payment = $('#id_my_payments').val();
			var id_new_payment_vid = $('#id_my_payments_vid option:selected').val();
			$('#id_my_old_payments_vid').val(admin_my_payments_tab_link);
				$('#products_err').html('asdasda');
//			saveMyPayment($('#id_my_payments').val(), $('#id_my_payments_vid option:selected').val());
			updateQty($('#id_product').val(), $('#ipa_'+$('#id_product').val()+' option:selected').val(), 0, $('#qty').val());
		});

	function saveMyPayment(id_new_payment, id_new_payment_vid)
	{
		$.ajax({
			type:"POST",
...
<div class="leadin">{block name="leadin"}{/block}</div>
	...
	<div class="form-group">
			<input type="text" id="id_my_payments" name="id_my_payments" value="{$my_payment}" />
			...
			<div class="col-lg-9">
				...
				<input type="text" id="id_my_old_payments_vid" name="id_my_payments_vid" value="{$currentVid}" />
			</div>
		</div>
		...
		<div id="carts">
			...
			<div class="form-group">
				<div class="col-lg-9 col-lg-offset-3">
					<button type="button" class="btn btn-default" id="submitSavePayment" />
...
<!-- Здесь конец ******************************************************************************************************************
 -->
<form class="form-horizontal" action="{$link->getAdminLink('AdminMy_Payments')|escape:'html':'UTF-8'}&amp;submitAdd{$table|escape:'html':'UTF-8'}=1" method="post" autocomplete="off">
