        ...
        switch ((int)Tools::getValue('entity')) {
            case $this->entities[$this->l('Combinations')]:
                ...
                $this->available_fields = array(
                    ...
                    'r1' => array('label' => $this->l('r1')),
                    'r2' => array('label' => $this->l('r2')),
                    'r3' => array('label' => $this->l('r3')),
                    'ean13' => array('label' => $this->l('EAN13')),
                    'ean13_2' => array('label' => $this->l('EAN13_2')),
                    'ean13_3' => array('label' => $this->l('EAN13_3')),
            ...
            case $this->entities[$this->l('Categories')]:
                $this->available_fields = array(
                    ...
                    'position' => array('label' => $this->l('Позиция')),
            ...
            case $this->entities[$this->l('Products')]:
                ...
                $this->available_fields = array(
                    ...
                    'max_discount' => array('label' => $this->l('Макс скидка')),
                    ...
                    'r2' => array('label' => $this->l('r2')),
                    'r3' => array('label' => $this->l('r3')),
                    'sgt' => array('label' => $this->l('Годен до')),
                    'sg' => array('label' => $this->l('Срок годности (лет)')),
                    'tip' => array('label' => $this->l('Основная категория')),
                    'action' => array('label' => $this->l('Акционный?')),
                    'rname' => array('label' => $this->l('Розничное наименование')),
                    'rtor' => array('label' => $this->l('Коэф-нт для розницы')),
                    'rprice' => array('label' => $this->l('Розничная цена')),
                    'r_sale_unity' => array('label' => $this->l('Розничная единица')),
                    'forag' => array('label' => $this->l('Для агентств?')),
                    'objem' => array('label' => $this->l('Объем коробки')),
                    'ean13' => array('label' => $this->l('EAN13')),
                    'ean13_2' => array('label' => $this->l('EAN13_2')),
                    'ean13_3' => array('label' => $this->l('EAN13_3')),
                    'upc' => array('label' => $this->l('UPC')),
                    ...
                    'sale_unity' => array('label' => 'Единица измерения'),
                    'parent_sale_unity' => array('label' => 'Единица измерения поставщика'),
                    'sale_unit_price_ratio' => array('label' => 'К-нт передачи ед. изм.'),
                    'sale_unity_pack' => array('label' => 'Описание фасовки'),
                    'country_prois' => array('label' => 'Страна происхождения'),
                    'sert' => array('label' => 'Сертификат кратко'),
                    'sert_full' => array('label' => 'Сертификат полный'),
                    'gtd' => array('label' => 'ГТД'),
            ...
            case $this->entities[$this->l('Customers')]:
                ...
                $this->required_fields = array('email', 'passwd', 'lastname', 'firstname', 'my_name');
                ...
                $this->available_fields = array(
                    ...
                    'phone1' => array('label' => $this->l('Телефон 1')),
                    'phone2' => array('label' => $this->l('Телефон 2')),
                    ...
                    'my_name' => array('label' => $this->l('Собственное обозначение *')),
                    'skid_1' => array('label' => $this->l('Скидка на Китай')),
                    'skid_2' => array('label' => $this->l('Скидка на Россию')),
                    'skid_3' => array('label' => $this->l('Скидка на Польшу')),
                    'id_employee' => array('label' => $this->l('ID менеджера')),
                    'id_trc' => array('label' => $this->l('ID ТК')),
                    'from_year' => array('label' => $this->l('С какого года')),
                    'own_folder' => array('label' => $this->l('Персональная папка')),
            ...
            case $this->entities[$this->l('Addresses')]:
                ...
                $this->available_fields = array(
                    ...
                    'vat_number' => array('label' => $this->l('ИНН и/или паспорт')),
            ...
            case $this->entities[$this->l('Suppliers')]:
                ...
                $this->available_fields = array(
                    ...
                    'active' => array('label' => $this->l('Active (0/1)')),
                    'name' => array('label' => $this->l('Name')),
                    'short_name' => array('label' => $this->l('Краткое наименование')),
                    /* 'sort' => array('label' => $this->l('Порядок сортировки')), */
                    'description' => array('label' => $this->l('Description')),
...
// Иванов                     foreach ($associated_warehouses_collection as $awc) {
//                               $awc->delete();
// Иванов                     }
...
// Иванов добавлено foreach shop
                        foreach ($shops as $shop) {
							StockAvailable::setProductDependsOnStock($product->id, $product->depends_on_stock, (int)$shop);
                        }
// Иванов ^						
                    }
            ...
            if (isset($info['attribute'])) {
                foreach (explode($this->multiple_value_separator, $info['attribute']) as $key => $attribute) {
                    ...
                    if (isset($groups_attributes[$key])) {
                        ...
                        if (!Validate::isEan13($info['ean13_2'])) {
                            $this->warnings[] = sprintf(Tools::displayError('EAN13 "%1s" has incorrect value for product with id %2d.'), $info['ean13_2'], $product->id);
                            $info['ean13_2'] = '';
                        }
                        if (!Validate::isEan13($info['ean13_3'])) {
                            $this->warnings[] = sprintf(Tools::displayError('EAN13 "%1s" has incorrect value for product with id %2d.'), $info['ean13_3'], $product->id);
                            $info['ean13_3'] = '';
                        }
            ...
            if (empty($this->errors)) {
                ...
                if (empty($this->errors)) {
                    ...
                    $query->select('
						...
						IFNULL(pa.ean13_2, IFNULL(p.ean13_2, \'\')) as ean13_2,
						IFNULL(pa.ean13_3, IFNULL(p.ean13_3, \'\')) as ean13_3,
                    ...
                    $supply_order_detail->ean13_2 = $product_infos['ean13_2'];
                    $supply_order_detail->ean13_3 = $product_infos['ean13_3'];
