...
class PDFCore
{
    ...
    {
//		Tools::redirectAdmin('http://presta6.newogonek.ru/admin005evg417/index.php?controller=AdminModules&token=d0af721f9fac57ef192098825ac23b96&configure=invoicepayru&invoice=32');
//		Tools::redirectAdmin(Context::getContext()->link->getAdminLink('AdminModules').'&configure=invoicepayru&invoice=32');
//		return ;
        $render = false;
