...
{if $location == 'top'}
<div class="ps-profile__block">
    {if !$logged}
    <a  class="ps-profile__button"
        href="/my-account"
        rel="nofollow"
    ...
    <div class="ps-profile__menu">
        <a  class="ps-profile__link"
        ...
        <a  class="ps-profile__link"
            href="{$link->getPageLink('order-follow', true)|escape:'html':'UTF-8'}"
            title="{l s='My merchandise returns' mod='blockmyaccount'}">
            {l s='My merchandise returns' mod='blockmyaccount'}
        </a>
        <a  class="ps-profile__link"
            href="{$link->getPageLink('order-slip', true)|escape:'html':'UTF-8'}"
        ...
        <a  class="ps-profile__link" 
            ...
            {l s='Sign out' mod='blockmyaccount'}<i class="icon-chevron-right right"></i>
        </a>
    </div>
    {/if}
</div>
