...
class FrontControllerCore extends Controller
{
    ...
    public function init()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'manufacts'           => Manufacturer::getManufacturers(),
    ...
    public function initContent()
    {
        ...
        if (!$this->useMobileTheme()) {
            ...
            $this->context->smarty->assign(array(
                ...
                'HOOK_TOP_HEAD'     => Hook::exec('displayTopHead'),
    ...
    public function setMedia()
    {
        ...
        $this->addjqueryPlugin('fancybox'); // добавлено 05-09-17 для отображения все не через jAlert
        $this->addJS(_PS_JS_DIR_.'tools.js');
    ...
    public function productSort()
    {
        ...
        $this->context->smarty->assign(array(
            'is_show_skid'          => ($this->context->customer->show_skid == 1 && Configuration::get('PS_IS_SHOW_DISCOUNT', null, null, (int)$this->context->shop->id) ? 1 : 0),
            'is_with_skid'          => $this->context->customer->with_skid,
            'isShowPriceWoDisc'          => $this->context->customer->show_price_wo_skid,
            'orderby'          => $this->orderBy,
            'orderway'         => $this->orderWay,
            'current_manuf'         => Tools::getValue('id_manufacturer'),
