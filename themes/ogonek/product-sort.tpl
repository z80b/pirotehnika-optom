...
{if isset($orderby) AND isset($orderway)}
	<ul id="displayType" class="display hidden-xs" data-display="list" style="margin-right: 40px;">
		<!-- <li class="display-title">{l s='View:'}</li> -->
		<li class="display-title" style="width:120px; text-align: right" >Способ отображения:</li>
		{*<li id="grid"><a class="sort-plitka" rel="nofollow" href="#" title="{l s='Grid'}"><!-- <i class="icon-th-large"></i> --><!-- {l s='Grid'} --></a></li>*}
		{*<li id="list"><a class="sort-list" rel="nofollow" href="#" title="{l s='List'}"><!-- <i class="icon-th-list"></i> --><!-- {l s='List'} --></a></li>*}
