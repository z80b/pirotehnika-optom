...
<form action="{$link->getModuleLink('cashondelivery', 'validation', [], true)|escape:'html'}" method="post">
    ...
    <p class="cart_navigation" id="cart_navigation">
        ...
        <button type="submit" class="button btn btn-default button-medium" onclick="yaCounter46713966.reachGoal('STEP4'); return true;"><span>{l s='I confirm my order' mod='cashondelivery'}</span></button>
    </p>
</form>
