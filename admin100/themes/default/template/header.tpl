...
<!-- 					<a href="http://pirotehnika-optom.ru/exim/toex.php?do=2 " id="quick_export"  ><span class="string-long" style="color: yellow; font-size: 120%" >Выгрузить</span></a>
					<span class="string-long" style="color: red; font-size: 150%" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
 -->
{if ($shop->id == 1)}
					<a href="http://pirotehnika-optom.ru/exim/toex2.php?do=217 " id="quick_import" target="_blank" ><span class="string-long" style="color: #00FF00; font-size: 120%" >Прайс</span> </a>
					<span class="string-long" style="color: red; font-size: 150%" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
					<a href="http://pirotehnika-optom.ru/exim/toex2.php?do=3 " id="quick_import" target="_blank" ><span class="string-long" style="color: yellow; font-size: 120%" >Загрузить</span> </a>
					<span class="string-long" style="color: red; font-size: 150%" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
					<a href="http://pirotehnika-optom.ru/exim/toex.php?do=6 " id="quick_import" target="_blank" ><span class="string-long" style="color: yellow; font-size: 120%" >По заказам</span> </a>
					<span class="string-long" style="color: red; font-size: 150%" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
					<a href="http://pirotehnika-optom.ru/exim/toex.php?id_employee=9&do=" id="quick_import" target="_blank" ><span class="string-long" style="color: #FF0000; font-size: 120%" >Все задачи</span> </a>
{/if}					
...
{/if}
				<ul id="header_employee_box">
					{if false && (!isset($logged_on_addons) || !$logged_on_addons) && (isset($display_addons_connection) && $display_addons_connection)}
