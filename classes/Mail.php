...
include_once(_PS_MODULE_DIR_.'SendGrid/loader.php');
...
class MailCore extends ObjectModel
{
    ...
    public static function sendMailTest($smtp_checked, $smtp_server, $content, $subject, $type, $to, $from, $smtp_login, $smtp_password, $smtp_port = 25, $smtp_encryption)
    {
        ...
        //Dotenv::load(__DIR__);
        $sendgrid_apikey = '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';
        //$sendgrid = new SendGrid($sendgrid_apikey);
        $url = 'https://api.sendgrid.com/';
        $pass = $sendgrid_apikey;
        $template_id = 'eec030ed-0af6-4925-b6a9-42194319b8eb';
        $js = array(
