        ...
        $this->fields_options = array(
            'general' => array(
                ...
                'fields' =>    array(
                    ...
                    'PS_INVOICE_NUMBER_ORDER' => array(
                        'title' => $this->l('The invoice number corresponds to the order number'),
                        'cast' => 'intval',
                        'type' => 'bool'
                    ),
                    ...
                    'PS_RUS_INVOICE_FORM' => array(
                        'title' => $this->l('Использовать шаблон счета, принятый в РФ'),
                        'desc' => $this->l('Если выбрать Да, то шаблон указанный ниже будет игнорирован.'),
                        'cast' => 'intval',
                        'type' => 'bool'
                    ),
