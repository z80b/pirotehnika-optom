...
$bgType = RevGlobalObject::getVar('bgType');
?>
<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important; min-width:1040px !important;">
                ...
                <span id="mainbg-sub-source" style="display:block">
                    ...
                    <span class="diblock bg-settings-block">
                        ...
                        if ($slider_type == 'posts' || $slider_type == 'specific_posts' || $slider_type == 'woocommerce') {
                            ...
                            ?>
                            <label><?php _e("Featured Image", 'revslider');
                            ...
                            ?>
                            <label><?php _e("Stream Image", 'revslider');
                            ...
                            <input type="radio" name="background_type" value="image" class="bgsrcchanger" data-callid="tp-bgimagewpsrc" data-imgsettings="on" data-bgtype="image" id="radio_back_image" <?php checked($bgType, 'image');
                               ...
                               ?>>
                                ...
                                if ($slider_type == 'vimeo' || $slider_type == 'youtube' || $slider_type == 'instagram' || $slider_type == 'twitter') {
                                    ...
                                    ?>
                                <div class="tp-clearfix"></div>
                                <label><?php _e("Stream Video", 'revslider');

                               ?></label>
                                <input type="radio" name="background_type" value="stream<?php echo $slider_type;

                                    ?>" class="bgsrcchanger" data-callid="tp-bgimagewpsrc" data-imgsettings="on" data-bgtype="stream<?php echo $slider_type;
                            ...
                            ?>>
                                <span id="streamvideo_cover" class="streamvideo_cover" style="display:none;margin-left:20px;">
                                    <span style="margin-right: 10px"><?php _e("Use Cover", 'revslider');

                                    ?></span>
                                    <input type="checkbox" class="tp-moderncheckbox" id="stream_do_cover" name="stream_do_cover" data-unchecked="off" <?php
                               $stream_do_cover = RevGlobalObject::getVar('stream_do_cover');
                               checked($stream_do_cover, 'on');
                                ...
                                <div class="tp-clearfix"></div>
                                <label><?php _e("Stream Video + Image", 'revslider');

                                    ?></label>
                                <input type="radio" name="background_type" value="stream<?php echo $slider_type;

                                    ?>both" class="bgsrcchanger" data-callid="tp-bgimagewpsrc" data-imgsettings="on" data-bgtype="stream<?php echo $slider_type;
                        ...
                        $stream_do_cover_both = RevGlobalObject::getVar('stream_do_cover_both');
    ...
    ?>
                            <label ><?php _e("Main / Background Image", 'revslider');
...
?>
                        ...
                        <span id="tp-bgimageextsrc" class="bgsrcchanger-div" style="display:none;margin-left:20px;">
                            <input type="text" name="bg_external" id="slide_bg_external" value="<?php echo RevGlobalObject::getVar('slideBGExternal'); ?>" <?php echo ($bgType != 'external') ? ' class="disabled"' : ''; ?>>
                        ...
                        <span id="tp-bgcolorsrc"  class="bgsrcchanger-div"  style="display:none;margin-left:20px;">
                            <input type="text" name="bg_color" id="slide_bg_color" class="my-color-field slide_bg_color inputColorPicker" value="<?php echo RevGlobalObject::getVar('slideBGColor');
                            ; ?>">
                        </span>
                        <div class="tp-clearfix"></div>
                        ...
                        <span id="tp-bgyoutubesrc" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
                            ...
                            <input type="text" name="slide_bg_youtube" id="slide_bg_youtube" value="<?php echo RevGlobalObject::getVar('slideBGYoutube'); ?>" <?php echo ($bgType != 'youtube') ? ' class="disabled"' : ''; ?>>							
<?php _e('example: T8--OggjJKQ', 'revslider'); ?>
                        ...
                        <span id="tp-bgvimeosrc" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
                            <label style="min-width:180px"><?php _e("ID:", 'revslider'); ?></label>
                            <input type="text" name="slide_bg_vimeo" id="slide_bg_vimeo" value="<?php echo RevGlobalObject::getVar('slideBGVimeo'); ?>" <?php echo ($bgType != 'vimeo') ? ' class="disabled"' : ''; ?>>							
<?php _e('example: 30300114', 'revslider'); ?>
                        ...
                        <span id="tp-bghtmlvideo" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
                            ...
                            <input type="text" name="slide_bg_html_mpeg" id="slide_bg_html_mpeg" value="<?php echo RevGlobalObject::getVar('slideBGhtmlmpeg'); ?>" <?php echo ($bgType != 'html5') ? ' class="disabled"' : ''; ?>>
                            ...
                            <input type="text" name="slide_bg_html_webm" id="slide_bg_html_webm" value="<?php echo RevGlobalObject::getVar('slideBGhtmlwebm'); ?>" <?php echo ($bgType != 'html5') ? ' class="disabled"' : ''; ?>>
                            <span class="vidsrcchanger-div" style="margin-left:20px;">
                            ...
                            <input type="text" name="slide_bg_html_ogv" id="slide_bg_html_ogv" value="<?php echo RevGlobalObject::getVar('slideBGhtmlogv'); ?>" <?php echo ($bgType != 'html5') ? ' class="disabled"' : ''; ?>>							
                            <span class="vidsrcchanger-div" style="margin-left:20px;">
                ...
                <span id="mainbg-sub-setting" style="display:none">
                    ...
                    <div class="rs-img-source-size">
                        ...
                        <span style="margin-right:20px">
                            ...
                            <?php
                            $img_sizes = RevGlobalObject::getVar('img_sizes');
                            $bg_image_size = RevGlobalObject::getVar('bg_image_size');
                    ...
                    <span id="tp-bgimagesettings" class="bgsrcchanger-div" style="display:none;">
                        ...
                        <p>
<?php
$slideParams = RevGlobalObject::getVar('slideParams');
...
<?php $alt_attr = RevSliderFunctions::getVal($slideParams, 'alt_attr', ''); ?>
                        ...
                        <p class="ext_setting" style="display: none;">
                            ...
                            <input type="text" name="ext_width" value="<?php echo RevGlobalObject::getVar('ext_width'); ?>" />
                        </p>
                        <p class="ext_setting" style="display: none;">
                            <label><?php _e('Height:', 'revslider') ?></label>
                            <input type="text" name="ext_height" value="<?php echo RevGlobalObject::getVar('ext_height'); ?>" />
                        </p>
                    </span>					
                    ...
                    <span id="video-settings" style="display: block;">
                        <p>
                            ...
                            <input type="checkbox" class="tp-moderncheckbox" id="video_force_cover" name="video_force_cover" data-unchecked="off" <?php $video_force_cover = RevGlobalObject::getVar('video_force_cover');
                        ...
                        <span id="video_dotted_overlay_wrap">
                            ...
                            <select id="video_dotted_overlay" name="video_dotted_overlay" style="width:100px">
                                <option <?php $video_dotted_overlay = RevGlobalObject::getVar('video_dotted_overlay');
                                selected($video_dotted_overlay, 'none'); ?> value="none"><?php _e('none', 'revslider'); ?></option>
...
<?php _e("Aspect Ratio:", 'revslider'); ?>
                        ...
                        <select id="video_ratio" name="video_ratio" style="width:100px">
                            <option <?php $video_ratio = RevGlobalObject::getVar('video_ratio');
selected($video_ratio, '16:9'); ?> value="16:9"><?php _e('16:9', 'revslider'); ?></option>
...
<?php _e("Start At:", 'revslider'); ?>
                            ...
                            <input type="text" value="<?php echo RevGlobalObject::getVar('video_start_at'); ?>" name="video_start_at"> <?php _e('For Example: 00:17', 'revslider'); ?>
                        <p style="clear: both;"></p>
                        </p>
                        <p>
                            <label for="video_ratio">
<?php _e("End At:", 'revslider'); ?>
                            ...
                            <input type="text" value="<?php echo RevGlobalObject::getVar('video_end_at'); ?>" name="video_end_at"> <?php _e('For Example: 02:17', 'revslider'); ?>
                        <p style="clear: both;"></p>
                        </p>
                        <p>
                            <label for="video_loop"><?php _e('Loop Video:', 'revslider'); ?></label>
                            <select id="video_loop" name="video_loop" style="width: 200px;">
                                <option <?php $video_loop = RevGlobalObject::getVar('video_loop');
selected($video_loop, 'none'); ?> value="none"><?php _e('Disable', 'revslider'); ?></option>
                        ...
                        <p>	
                            ...
                            <input type="checkbox" class="tp-moderncheckbox" id="video_nextslide" name="video_nextslide" data-unchecked="off" <?php $video_nextslide = RevGlobalObject::getVar('video_nextslide');
checked($video_nextslide, 'on'); ?>>
                        </p>
                        <p>
                            <label for="video_force_rewind"><?php _e('Rewind at Slide Start:', 'revslider'); ?></label>
                            <input type="checkbox" class="tp-moderncheckbox" id="video_force_rewind" name="video_force_rewind" data-unchecked="off" <?php $video_force_rewind = RevGlobalObject::getVar('video_force_rewind');
checked($video_force_rewind, 'on'); ?>>
                        </p>

                        <p>	
                            <label for="video_mute"><?php _e('Mute Video:', 'revslider'); ?></label>
                            <input type="checkbox" class="tp-moderncheckbox" id="video_mute" name="video_mute" data-unchecked="off" <?php $video_mute = RevGlobalObject::getVar('video_mute');
checked($video_mute, 'on'); ?>>
                        ...
                        <p class="vid-rev-vimeo-youtube video_volume_wrapper">
                            ...
                            <input type="text" id="video_volume" name="video_volume" <?php echo RevGlobalObject::getVar('video_volume'); ?>>
                        </p>
                        ...
                        <span id="vid-rev-youtube-options">
                            <p>
                                ...
                                <select id="video_speed" name="video_speed" style="width:75px">
                                    <option <?php $video_speed = RevGlobalObject::getVar('video_speed');
                            selected($video_speed, '0.25'); ?> value="0.25"><?php _e('0.25', 'revslider'); ?></option>
                            ...
                            <p>
                                ...
                                <input type="text" id="video_arguments" name="video_arguments" style="width:350px;" value="<?php echo RevGlobalObject::getVar('video_arguments'); ?>">
                            </p>
                        </span>
                        <p id="vid-rev-vimeo-options">
                            <label><?php _e('Arguments Vimeo:', 'revslider'); ?></label>
                            <input type="text" id="video_arguments_vim" name="video_arguments_vim" style="width:350px;" value="<?php echo RevGlobalObject::getVar('video_arguments_vim'); ?>">
                        </p>
                    </span>
                    ...
                    <span id="bg-setting-wrap">
                        <p>
                            ...
                            <select name="bg_fit" id="slide_bg_fit" style="margin-right:20px">
                                <option value="cover"<?php $bgFit = RevGlobalObject::getVar('bgFit');
...
?> width:60px;margin-right:10px" value="<?php echo RevGlobalObject::getVar('bgFitX'); ?>" />
                            <input type="text" name="bg_fit_y" style="min-width:54px;width:54px;  <?php
                                if ($bgFit != 'percentage') {
                                    echo 'display: none; ';
                                }

?> width:60px;margin-right:10px"  value="<?php echo RevGlobalObject::getVar('bgFitY'); ?>" />
                        </p>
                        <p>
                            ...
                            <span id="bg-start-position-wrapper">
                                <select name="bg_position" id="slide_bg_position">
                                    <option value="center top"<?php $bgPosition = RevGlobalObject::getVar('bgPosition');
                        selected($bgPosition, 'center top'); ?>>center top</option>
                                ...
                                <input type="text" name="bg_position_x" style="min-width:54px;width:54px; <?php
                                        ...
                                        ?>width:60px;margin-right:10px" value="<?php echo RevGlobalObject::getVar('bgPositionX'); ?>" />
                                <input type="text" name="bg_position_y" style="min-width:54px;width:54px; <?php
                                    if ($bgPosition != 'percentage') {
                                        echo 'display: none;';
                                    }

                                    ?>width:60px;margin-right:10px" value="<?php echo RevGlobalObject::getVar('bgPositionY'); ?>" />
                            </span>
                        </p>
                        ...
                        <p>
                            ...
                            <span>
                                <select name="bg_repeat" id="slide_bg_repeat" style="margin-right:20px">
                                    <option value="no-repeat"<?php $bgRepeat = RevGlobalObject::getVar('bgRepeat');
                ...
                <span id="mainbg-sub-parallax" style="display:none">
                    <p>
                                    <?php
                                    if (RevGlobalObject::getVar('use_parallax') == "off") {
                                        echo '<i style="color:#c0392b">';
                                        _e("Parallax Feature in Slider Settings is deactivated, parallax will be ignored.", 'revslider');
                                        echo '</i>';
                                    } else {
                                        if (RevGlobalObject::getVar('parallaxisddd') == "off") {

                                            ?>
                                <label><?php _e("Parallax Level:", 'revslider');

                                            ?></label>
                                <select name="slide_parallax_level" id="slide_parallax_level">
                                    <option value="-" <?php
                                $slide_parallax_level = RevGlobalObject::getVar('slide_parallax_level');
                                selected($slide_parallax_level, '-');

                                ?>><?php _e('No Parallax', 'revslider');

                                ?></option>
                                    <option value="1" <?php selected($slide_parallax_level, '1');

                            ?>>1 - (<?php
                                $parallax_level = RevGlobalObject::getVar('parallax_level');
        ...
        if (RevGlobalObject::getVar('parallaxbgfreeze') == "off") {

            ?>							
                                    <label><?php _e("Selected 3D Depth:", 'revslider');

            ?></label>
                                    <input style="min-width:54px;width:54px" type="text" disabled value="<?php echo $parallax_level[15];

            ?>%" />							
                                    <span><i><?php _e('3D Parallax is Enabled via Slider Settings !', 'revslider');
            ...
            ?>
                                    <label><?php _e("Background 3D is Disabled", 'revslider');

            ?></label>									
                                    <span style="display: inline-block;vertical-align: middle;line-height:32px"><i><?php _e('To Enable 3D Parallax for Background please change the Option "BG 3D Disabled" to "OFF" via the Slider Settings !', 'revslider');
...
?>
                ...
                <span id="mainbg-sub-kenburns" style="display:none">
                    <p>
                        ...
                        <input type="checkbox" class="tp-moderncheckbox withlabel" id="kenburn_effect" name="kenburn_effect" data-unchecked="off" <?php $kenburn_effect = RevGlobalObject::getVar('kenburn_effect');
checked($kenburn_effect, 'on'); ?>>
                    ...
                    <span id="kenburn_wrapper" <?php echo ($kenburn_effect == 'off') ? 'style="display: none;"' : ''; ?>>						
                        <p>
                            ...
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_fit" value="<?php echo (int) (RevGlobalObject::getVar('kb_start_fit')); ?>" />
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_fit" value="<?php echo (int) (RevGlobalObject::getVar('kb_end_fit')); ?>" />
                        </p>

                        <p>
                            <label><?php _e('Horizontal Offsets:', 'revslider') ?></label>
                            <label style="min-width:40px"><?php _e('From', 'revslider'); ?></label>							
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_offset_x" value="<?php echo RevGlobalObject::getVar('kbStartOffsetX'); ?>" />
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_offset_x" value="<?php echo RevGlobalObject::getVar('kbEndOffsetX'); ?>" />
                        ...
                        <p>
                            ...
                            <label style="min-width:40px"><?php _e('From', 'revslider'); ?></label>												
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_offset_y" value="<?php echo RevGlobalObject::getVar('kbStartOffsetY'); ?>" />
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_offset_y" value="<?php echo RevGlobalObject::getVar('kbEndOffsetY'); ?>" />
                            <span><i><?php _e('Use Negative and Positive Values to offset from the Center !', 'revslider'); ?></i></span>
                        </p>
                        ...
                        <p>
                            ...
                            <label style="min-width:40px"><?php _e('From', 'revslider'); ?></label>												
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_rotate" value="<?php echo RevGlobalObject::getVar('kbStartRotate'); ?>" />
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_rotate" value="<?php echo RevGlobalObject::getVar('kbEndRotate'); ?>" />
                        </p>

                        <p>
                            <label><?php _e('Easing:', 'revslider'); ?></label>
                            <select name="kb_easing">
                                <option <?php $kb_easing = RevGlobalObject::getVar('kb_easing');
                    selected($kb_easing, 'Linear.easeNone'); ?> value="Linear.easeNone">Linear.easeNone</option>
                        ...
                        <p>
                            ...
                            <input type="text" name="kb_duration" value="<?php echo (int) (RevGlobalObject::getVar('kb_duration')); ?>" />
                        </p>
                    </span>
                </span>

                <input type="hidden" id="image_url" name="image_url" value="<?php echo RevGlobalObject::getVar('imageUrl'); ?>" />
                <input type="hidden" id="image_id" name="image_id" value="<?php echo RevGlobalObject::getVar('imageID'); ?>" />
            </div>
...
if ((int) ($slide_thumb) > 0) {
    ...
    ?>
                                <div style="width:100px;height:70px;background:url('<?php echo admin_url('admin-ajax.php');

    ?>?action=revslider_show_image&amp;img=<?php echo $slide_thumb;
...
<?php $thumb_for_admin = RevSliderFunctions::getVal($slideParams, 'thumb_for_admin', 'off'); ?>
            ...
            <div id="slide-animation-settings-content" style="display:none">
                ...
                <div id="slide_transition_row">
                        <?php
                        $slide_transition = RevSliderFunctions::getVal($slideParams, 'slide_transition', RevGlobalObject::getVar('def_transition'));
                        ...
                        $transitions = RevGlobalObject::getVar('operations')->getArrTransition();
                        ...
                        <?php $transition_duration = (array) RevSliderFunctions::getVal($slideParams, 'transition_duration', RevGlobalObject::getVar('def_transition_duration')); ?>
...
for ($i = 1; $i <= 10; $i++) {
    ...
    ?>
                    <p>
                            <?php
                            _e('Parameter', 'revslider');
                            echo ' ' . $i;

                            ?> <input type="text" name="params_<?php echo $i;

                            ?>" value="<?php echo Tools::stripslashes(RevSliderFunctions::getVal($slideParams, 'params_' . $i, ''));

                            ?>">
                            <?php _e('Max. Chars', 'revslider');

                            ?> <input type="text" style="width: 50px; min-width: 50px;" name="params_<?php echo $i;

                            ?>_chars" value="<?php echo RevSliderFunctions::getVal($slideParams, 'params_' . $i . '_chars', 10, RevSlider::FORCE_NUMERIC);
                ...
                <!-- BASIC DESCRIPTION -->
                <p>
<?php $slide_description = Tools::stripslashes(RevSliderFunctions::getVal($slideParams, 'slide_description', '')); ?>
...
<?php $id_attr = RevSliderFunctions::getVal($slideParams, 'id_attr', ''); ?>
                ...
                <!-- CUSTOM FIELDS -->
                <p>
<?php $data_attr = Tools::stripslashes(RevSliderFunctions::getVal($slideParams, 'data_attr', '')); ?>
...
<script type="text/javascript">
    var rs_plugin_url = '<?php echo addslashes(_MODULE_DIR_ . "revsliderprestashop/"); ?>';
