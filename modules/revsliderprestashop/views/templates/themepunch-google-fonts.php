    ...
    if (!empty($custom_fonts)) {
        foreach ($custom_fonts as $font) {
            ...
            <div class="postbox eg-postbox" style="width:100%;min-width:500px">
                <h3 class="box-closed"><span style="font-weight:400"><?php echo RevsliderPrestashop::$lang['Font_Family'];
            ...
            ?></span><span style="text-transform:uppercase;"><?php echo $title;
                ...
                <div class="inside" style="display:none;padding:0px !important;margin:0px !important;height:100%;position:relative;background:#ebebeb">
                    <div class="tp-googlefont-row">
                        <div class="eg-cus-row-l"><label><?php echo RevsliderPrestashop::$lang['Handle'];

                ?></label> tp-<input type="text" name="esg-font-handle[]" value="<?php echo @$font['handle'];

            ?>" readonly="readonly"></div>
                        <div class="eg-cus-row-l"><label><?php echo RevsliderPrestashop::$lang['Parameter'];
                    ...
                    <div class="tp-googlefont-save-wrap-settings">
                        <a class="button-primary revblue eg-font-edit" href="javascript:void(0);"><?php echo RevsliderPrestashop::$lang['Edit'];

            ?></a>
                        <a class="button-primary revred eg-font-delete" href="javascript:void(0);"><?php echo RevsliderPrestashop::$lang['Remove'];
