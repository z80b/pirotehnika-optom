...
{else}
    ...
    <section class="ps-footer__block ps-block">
        ...
        <ul class="ps-block__list ps-list">
            ...
            <li class="ps-list__item">
                <a class="ps-list__link" href="{$link->getCMSLink(53,'privacy-policy')|escape:'html':'UTF-8'}" title="{l s='Политика конфиденциальности' mod='blockcms'}">
                    {l s='Политика конфиденциальности' mod='blockcms'}
                </a>
            </li>
            {/if}
        </ul>
