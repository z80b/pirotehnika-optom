	...
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="panel clearfix">
				...
				<div class="form-horizontal">
					<div class="row">
						<label class="control-label col-lg-3">{l s='Менеджер'}</label>
						<div class="col-lg-9">
					...
					<div class="row">
						<label class="control-label col-lg-3">{l s='Фамилия'}</label>
						<div class="col-lg-9">
							<p class="form-control-static">{$customer->lastname}</p>
						</div>
					</div>
					<div class="row">
						<label class="control-label col-lg-3">{l s='Имя'}</label>
						<div class="col-lg-9">
							<p class="form-control-static">{$customer->firstname}</p>
						</div>
					</div>
					<div class="row">
						<label class="control-label col-lg-3">{l s='Телефон 1'}</label>
						<div class="col-lg-9">
							<p class="form-control-static">{$customer->phone1}</p>
						</div>
					</div>
					<div class="row">
						<label class="control-label col-lg-3">{l s='Телефон 2'}</label>
						<div class="col-lg-9">
							<p class="form-control-static">{$customer->phone2}</p>
						</div>
					</div>
					<div class="row">
					...
					{/if}
					{if $is_show_show_skid}
						<div class="row">
							<label class="control-label col-lg-3">Видит цены со скидкой</label>
							<div class="col-lg-9">
								<p class="form-control-static">{if $customer->show_skid == 1}Да{else}Нет{/if}</p>
							</div>
						</div>
					{/if}
					<div class="row">
			...
			<div class="panel">
				...
				<p class="text-muted text-center">
					{if !$is_show_fio}
						{l s='%1$s %2$s has not placed any orders yet' sprintf=[$customer->my_name, '']}
					{else}	
		...
		<div class="col-lg-6">
			...
			<div class="panel">
				...
				<p class="text-muted text-center">
					{if !$is_show_fio}
						{l s='%1$s %2$s has never contacted you' sprintf=[$customer->my_name, '']}
					{else}	
			...
			<div class="panel">
				...
				<p class="text-muted text-center">
					{if !$is_show_fio}
						{l s='%1$s %2$s has no discount vouchers' sprintf=[$customer->my_name, '']}
					{else}	
		...
		<div class="col-lg-12">
			<div class="panel">
				...
				{else}
					<p class="text-muted text-center">
					{if !$is_show_fio}
						{l s='%1$s %2$s has not registered any addresses yet' sprintf=[$customer->my_name, '']}
					{else}	
