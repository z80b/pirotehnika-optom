    ...
    public function __construct()
    {
        ...
        $this->fields_options = array(
            'general' => array(
                ...
                'icon' =>    'icon-cogs',
                'fields' =>    array(
                     'PS_ORDER_RPERIOD' => array(
                        'title' => 'Текущий сезон (рабочий период)',
                        'desc' => 'Все заказы и оплаты будут относиться к этому сезону',
                        'size' => 4,
                        'type' => 'text',
                        'cast' => 'intval'
                    ),
                     'PS_ORDER_START_NUMBER' => array(
                        'title' => 'Номер заказа',
                        'desc' => sprintf('Следующий заказ получит этот номер. Оставьте поле пустым, чтобы не менять нумерацию(текущий номер #%s).', Order::getLastOrderNumber() + 1),
                        'size' => 6,
                        'type' => 'text',
                        'cast' => 'intval'
                    ),
                    'PS_ORDER_RESET' => array(
                        'title' => 'Сбрасывать нумерацию в начале нового года',
                        'cast' => 'intval',
                        'type' => 'bool'
                    ),
                     'PS_NEXT_NDS_NUMBER' => array(
                        'title' => 'Номер следующего счета-фактуры',
                        'desc' => 'Изменять в случае крайней необходимости!',
                        'size' => 6,
                        'type' => 'text',
                        'cast' => 'intval'
                    ),
                    'PS_ORDER_MY_CONTROL_PANEL' => array(
                        'title' => $this->l('Использовать собсвенную панель управления заказами'),
                        'cast' => 'intval',
                        'type' => 'bool'
                    ),
